...
public static class SetsAndMaps
{
    ...
    public static bool IsAnagram(string word1, string word2)
    {
        ...
        foreach (var character in word1)
        {
            ...
            letterCounts[normalizedCharacter] = letterCounts.GetValueOrDefault(normalizedCharacter) + 1;
        }
        ...
        foreach (var character in word2)
        {
            ...
            var normalizedCharacter = char.ToLowerInvariant(character);
            if (!letterCounts.TryGetValue(normalizedCharacter, out var count))
            {
                return false;
            }
            ...
            if (count == 1)
            {
                letterCounts.Remove(normalizedCharacter);
            }
            else
            {
                letterCounts[normalizedCharacter] = count - 1;
            }
        }
