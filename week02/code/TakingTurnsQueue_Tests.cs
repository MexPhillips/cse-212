...
public class TakingTurnsQueueTests
{
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Infinite-turn people were not re-added to the queue, causing the test to throw when the finite-turn people were exhausted.
    ...
    // Defect(s) Found: Infinite-turn people were not re-added to the queue, causing the test to throw when Sue's finite turns were exhausted.
